...
function openPOInvoice(poId, autoPrint) {
  ...
  openModal(`
    ...
    <div class="invoice-page" id="invoiceArea" style="max-width:520px;font-family:Arial;">
      ...
      <div class="line"></div>
      <div style="text-align:center;font-size:10px;margin-top:8px;color:#666;">Generated by Mr Laundry POS</div>
    </div>
  `, { large: true, onOpen(){
...
function showWeeklyInvoice(vendorId, from, to) {
  ...
  openModal(`
    ...
    <div class="invoice-page" id="invoiceArea" style="max-width:700px;font-family:Arial;">
      ...
      <div style="text-align:center;font-size:10px;margin-top:14px;color:#666;">Generated on ${new Date().toLocaleString()} by Mr Laundry POS</div>
    </div>
  `, { large: true });
}
